...
class Controller:
    ...
    def __init__(self, db_name=None):
        ...
        self.gametime = GameTime(self.view.lbl_time)  # loob objekti, et saaks gametime kasutada
    def main(self):
        self.view.main()
    def click_btn_new(self):
        ...
        self.view.change_image(0)  # Image change with index. kõige esimene pilt, mis on täiesti valge
        self.model.start_new_game()  # starting a new game
    ...
    def click_btn_send(self):
        ...
        self.view.lbl_result.configure(text=self.model.user_word)
        self.view.lbl_error.configure(text=f'Wrong {self.model.counter} letter(s). {self.model.get_all_user_chars()}')   # f tähendab vormindatud tekst
        self.view.char_input.delete(0, 'end')
    ...
    def is_game_over(self):
        # 11, sest 11 pilti kaustas ja siis joonistus valmis
    ...
    def click_btn_leaderboard(self):
        ...
        # nüüd tuleb funktsioon ka panna leaderboard nupule külge View lehel
